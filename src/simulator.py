...
"""initilizing the field with the width and height given by end user, Storing the car objects, and  runs a step-by-step 
simulation of each car movement, Detects and prints collision information Outputs final position of all active car 
which arr not coliided yet """
...
class Simulator: 
    ...
    def run(self):
        ...
        """ this function will executes the rotation of every cars while iterating through each stemp. 
                ...
                if command == 'L':
                    ...
                    for other in self.car_data:
                        ...
                        if next_x == ox and next_y == oy:
                            ...
                            collision_step = step + 1               # step number 
